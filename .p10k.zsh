# Generated by Powerlevel10k configuration wizard on 2025-06-07 at 12:42 -05.
...
# lightest, angled separators, slanted heads, flat tails, 2 lines, disconnected,
...
() {
  ...
  #     '~/work(|/*)'  WORK     ''
  #   '/home/pablo/Documents/Machines(|/*)'  MACHINES  ''
      '~'       HOME     ' '
      '*'       DEFAULT  ' ')
  #
